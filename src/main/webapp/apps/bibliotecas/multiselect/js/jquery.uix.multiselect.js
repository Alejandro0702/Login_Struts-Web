...
;(function($, window, undefined) {
    ...
    $.widget("uix.multiselect", {
        options: {
            ...
            filterSelected: true,         // when searching, filter selected options also? (default: false)
            ...
            moveEffectSpeed: 'fast',         // string ('slow','fast') or number in millisecond (ignored if moveEffect is 'show') (default: null)
...
//            console.log('insertIndex:'+insertIndex+'_'+gData.startIndex);
...
//            	console.log('if');
                //gDataDst.listContainer.prepend(eData.listElement);  // insert first
//            	console.log(gDataDst.listContainer.children().last());
            	gDataDst.listContainer.append(eData.listElement);
            } else {
//            	console.log('else');
                var prev = gDataDst.listContainer.children().last();//this._elements[insertIndex].listElement;
                //console.log(prev);
