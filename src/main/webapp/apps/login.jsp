...
<div id="id01" class="modalLogin">
  ...
  <div class="alert alert-success" style="display: none;">
	...
	<div id="E" class="alert alert-error" style="display: none;">
    ...
    <script type="text/javascript" src="apps_js/plugins/charts/sparkline.min.js"></script>	
	<script type="text/javascript" src="apps_js/plugins/forms/select2.min.js"></script>
    <script type="text/javascript" src="apps_js/plugins/forms/inputmask.js"></script>
    <script type="text/javascript" src="apps_js/plugins/forms/autosize.js"></script>
    <script type="text/javascript" src="apps_js/plugins/forms/inputlimit.min.js"></script>
    <script type="text/javascript" src="apps_js/plugins/forms/listbox.js"></script>
    <script type="text/javascript" src="apps_js/plugins/forms/multiselect.js"></script>
    <script type="text/javascript" src="apps_js/plugins/forms/validate.min.js"></script>
    <script type="text/javascript" src="apps_js/plugins/forms/tags.min.js"></script>
    <script type="text/javascript" src="apps_js/plugins/forms/switch.min.js"></script>
    <script type="text/javascript" src="apps_js/plugins/forms/uploader/plupload.full.min.js"></script>
    <script type="text/javascript" src="apps_js/plugins/forms/uploader/plupload.queue.min.js"></script>
    <script type="text/javascript" src="apps_js/plugins/forms/wysihtml5/wysihtml5.min.js"></script>
    <script type="text/javascript" src="apps_js/plugins/forms/wysihtml5/toolbar.js"></script>
    <script type="text/javascript" src="apps_js/plugins/interface/daterangepicker.js"></script>
    <script type="text/javascript" src="apps_js/plugins/interface/fancybox.min.js"></script>
    <script type="text/javascript" src="apps_js/plugins/interface/moment.js"></script>
    <script type="text/javascript" src="apps_js/plugins/interface/jgrowl.min.js"></script>
    <script type="text/javascript" src="apps_js/plugins/interface/datatables.min.js"></script>
    <script type="text/javascript" src="apps_js/plugins/interface/colorpicker.js"></script>
    <script type="text/javascript" src="apps_js/plugins/interface/fullcalendar.min.js"></script>
    <script type="text/javascript" src="apps_js/plugins/interface/timepicker.min.js"></script>	
	<script src="apps_js/index.js"></script>
